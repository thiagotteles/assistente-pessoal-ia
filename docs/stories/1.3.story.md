...
- **Dependências**: Knowledge-base Manager, daily-dump.md, Agent Memory System
...
- **Dependências**: Knowledge-base Manager, Agent Memory, daily-dump.md
...
- `despejo/daily-dump.md` - Arquivo processado pelo /organizador
