...
- [x] Tarefa 3: Criar estrutura completa de diretórios (CA: 1, 4)
  ...
  - [x] Criar `despejo/` com `daily-dump.md` inicial
...
- `despejo/daily-dump.md` - Arquivo de captura rápida inicial (394 bytes)
...
- **Arquivos essenciais**: README.md, .gitignore, CHANGELOG.md, daily-dump.md
