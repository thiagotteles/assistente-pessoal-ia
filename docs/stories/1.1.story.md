...
- ✅ **Sistema daily-dump.txt TDAH-friendly** com template intuitivo e sem fricção
...
- [x] daily-dump.txt com template TDAH-friendly e instruções claras
...
- daily-dump.txt sem validação que causaria fricção
